"""
Django settings for silent_disk_dev_93650 project.
...
ROOT_URLCONF = 'silent_disk_dev_93650.urls'
...
WSGI_APPLICATION = 'silent_disk_dev_93650.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "silent_disk_dev_93650 API",
    "DESCRIPTION": "API documentation for silent_disk_dev_93650 App",
    "VERSION": "v1",
}
